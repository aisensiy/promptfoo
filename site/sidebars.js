...
const redTeamSidebar = [
  ...
  },
  {
    ...
    items: [
      {
        type: 'category',
        label: 'Coding Agents and Harnesses',
        collapsed: true,
        items: [
          'red-team/plugins/coding-agent',
          {
            type: 'autogenerated',
            dirName: 'red-team/plugins/coding-agent',
          },
          'red-team/plugins/harness',
          {
            type: 'autogenerated',
            dirName: 'red-team/plugins/harness',
          },
        ],
      },
      {
