...
This example compares OpenAI's GPT-5.4, Anthropic's Claude Sonnet 4.6, and Google's Gemini on riddle-solving tasks with cost, latency, and quality assertions.
